...
public class string {
	...
	public string locale_to_utf8 (ssize_t len, out size_t bytes_read = null, out size_t bytes_written = null) throws GLib.ConvertError;
	[CCode (cname = "g_locale_from_utf8")]
	public string locale_from_utf8 (ssize_t len, out size_t bytes_read = null, out size_t bytes_written = null) throws GLib.ConvertError;
